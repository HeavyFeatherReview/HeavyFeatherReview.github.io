...
var weather = [
    /* 1 */
    { type: 'wind', name: '<div>argue with the divination of my keyboard.</div><div class="second-line">&nbsp;&nbsp;&nbsp;&nbsp;is there not a divine Sparrow flapping its marble</div>' },
    /* 2 */
    { type: 'snow', name: '<div>wings in the cello-heart of language? dark crows caw</div><div class="second-line">&nbsp;&nbsp;&nbsp;&nbsp;into the evening. I search for a lamp. I find</div>' },
    /* 3 */
    { type: 'sun', name: '<div>a tulip. don&#39;t ask me how. my hands know the smell</div><div class="second-line">&nbsp;&nbsp;&nbsp;&nbsp;of Spring. a boy hits his toy car on the concrete</div>' },
    /* 4 */
    { type: 'thunder', name: '<div>over &amp; over. it doesn&#39;t break. he takes it to</div><div class="second-line">&nbsp;&nbsp;&nbsp;&nbsp;his roboto mouth. they bathe the body,</div>' },
    /* 5 */
    { type: 'rain', name: '<div>they give it to the earth. holy holy sacrifice.</div><div class="second-line">&nbsp;&nbsp;&nbsp;&nbsp;the boy rises from the ground. he falls back</div><div id="final-line">as salt.</div>' },
];
